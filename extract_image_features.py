...
def get_args(parser):
    parser.add_argument("--dataset_dir", type=str, default="./twitter/")
    parser.add_argument("--image_dir", type=str, default="./twitter/images/")
    parser.add_argument("--feature_dir", type=str, default="./twitter/")
